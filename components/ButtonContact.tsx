...
const ButtonContact: FC<ButtonContactInput> = ({ title, Icon, Class }) => {
  return (
    <div
      className={`${Class ?? ""} duration-300 bg-purple-500 hover:bg-purple-600
  dark:bg-slate-900 text-white dark:text-slate-200
    fill-white  dark:fill-slate-200 flex justify-center 
    items-center rounded-lg sm:rounded-none hover:rounded-lg border-2 py-1 px-3 font-medium
     border-purple-400 dark:border-slate-200 
     dark:hover:bg-gray-700 m-1 hover:scale-105
     shadow-md hover:shadow-lg hover:shadow-purple-300 shadow-gray-300 dark:shadow-none`}
    >
