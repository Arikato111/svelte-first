    ...
    <div className="h-[390px] mb-5">
      <div className="img-block p-1 duration-500 relative inline-block  w-[320px] h-[390px] overflow-hidden dark:border-slate-200">
        <div className=" shadow-none overflow-hidden">
          <div className="dark:saturate-50 dark:hover:saturate-100 duration-300 overflow-hidden rounded-md border-2 border-purple-400 dark:border-slate-500 shadow-md shadow-gray-300 dark:shadow-gray-800">
            <img
              width={300}
              height={200}
